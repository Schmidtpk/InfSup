...
# save under?
macro$file_name <- "submission low reporting"
...
# which model to use?
macro$model_name <- "base error reporting"
...
macro$notes <- append(macro$notes,"reporting rate from 0.25 to 0.125")
