...
macro$notes <- append(macro$notes,"b: drop traced ratio")
...
# from "inferring ineffectiveness..." science paper mean (infection to report): N(10.92,sd = 0.94)
...
macro$sd_SI <- 3
#RCovModel::plot_gamma_dist(macro$mean_SI_mean,macro$sd_SI)
