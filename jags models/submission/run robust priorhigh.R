...
# save under?
macro$file_name <- "robust priorhigh"
...
macro$notes <- append(macro$notes,"different priors for effect")
...
# change to main model: different prior
macro$effect_sd <- macro$effect_sd*2
