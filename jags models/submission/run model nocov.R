...
# save under?
macro$file_name <- "submission_nocovT"
...
macro$notes <- append(macro$notes,"no weather, traced, info")
macro$notes <- append(macro$notes,"awareness rising")
...
# drop awareness rising
macro$dummies.interventions <- setdiff(macro$dummies.interventions,c("speechlimited","speechMerkel"))
