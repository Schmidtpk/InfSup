...
# save under?
macro$file_name <- "submission_semi"
...
# which model to use?
macro$model_name <- "base error semi"
...
macro$notes <- append(macro$notes,"const disp model")
macro$notes <- append(macro$notes,"semi mechanistic model")
